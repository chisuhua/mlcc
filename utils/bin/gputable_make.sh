...
#                     typically gets installed in $HCC2/bin/gputable.txt.
...
#      PCIID_FILE         $HOME/git/hcc2/pciids/pci.ids
...
if [ -z $PCIID_FILE ] ; then 
   ...
   if [ -f $HOME/git/hcc2/pciids/pci.ids ] ; then 
      echo " WARNING:  Getting pci.ids file from $HOME/git/hcc2/pciids/pci.ids"
      PCIID_FILE="$HOME/git/hcc2/pciids/pci.ids"
